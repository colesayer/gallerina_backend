...
user = User.create(name: 'Cole Sayer', email_address: 'colesayerstudio@gmail.com', password_digest: "password")
# Gallery.create(user_id: user.idr, gallery_name: "Nada Miami Beach", dim_x: 120, dim_y: 84, dim_z: 120 )
...
Artwork.create(user_id: 1, artist: 'Cole Sayer', title: 'The Original Version', date: '2015', materials: 'flashe and acrylic on canvas', image_url: 'https://res.cloudinary.com/dwnehv6tb/image/upload/v1511555350/fxecrajdqophrxgxbigf.jpg', dim_x: 48, dim_y: 72 )
